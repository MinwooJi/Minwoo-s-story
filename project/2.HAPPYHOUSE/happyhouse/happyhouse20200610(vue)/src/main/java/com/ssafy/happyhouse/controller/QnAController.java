...
public class QnAController {
    ...
    @ApiOperation(value = "QnA번호에 해당하는 QnA의 정보를 반환한다.", response = QnA.class)    
	@GetMapping("{qnaNo}")
    ...
    @ApiOperation(value = "QnA번호에 해당하는 QnA의 정보를 수정한다. 그리고 DB수정 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
   	@PutMapping("{qnaNo}")
    ...
    @ApiOperation(value = "QnA번호에 해당하는 게시글의 QnA를 삭제한다. 그리고 DB삭제 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
	@DeleteMapping("{qnaNo}")
