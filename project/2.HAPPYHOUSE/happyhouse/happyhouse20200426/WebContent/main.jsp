...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/00.bs4.css" />
</head>
<body>
	<div class="container">
...
<script>
	...
	function callHouseDealInfo(aptName) {
		$.ajax({
   			url:"${pageContext.request.contextPath}/SelectBoxController",
   			dataType:"json",
   			data:{command:"selectByName",AptName:aptName},
