<template>
  <div class="jobaramain">
    ...
    <!-- END Lamp -->
    <section class="jobara">
      <!-- Content -->
      <div class="jobara__content">
        <div class="jobara__message message">
          <h1 class="message__title">JOB A RA</h1>
          <p class="message__text">Hello this is JOB A RA WORLD</p>
          <p class="message__text">open your world</p>
        </div>
        <div class="error__nav e-nav">
          <router-link
            ...
            to="/user/login"
            target="_blanck"
            class="login_link e-nav__link"
          ></router-link>
          <router-link
            v-if="loginUserId"
            to="/jobara"
            target="_blanck"
            class="home_link e-nav__link"
          ></router-link>
        </div>
      </div>
      <!-- END Content -->
...
.in-cover .bulb {
  ...
  margin: 0px auto;
  /* 형광등 주변 색 */
  -webkit-box-shadow: 0 0 15px 7px rgba(255, 217, 0, 0.8),
    0 0 40px 25px rgba(255, 247, 0, 0.5),
    -75px 0 30px 15px rgba(251, 255, 0, 0.2);
  box-shadow: 0 0 25px 7px rgb(255 255 255 / 80%),
    0 0 64px 47px rgba(222, 226, 0, 0.5), 0px 0 30px 15px rgba(125, 28, 80, 0.2);
}
/* 빛 색 */
.light {
  width: 200px;
  height: 0px;
  border-bottom: 900px solid rgb(255 250 205 / 24%);
