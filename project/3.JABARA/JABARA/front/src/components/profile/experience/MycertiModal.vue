    ...
    <div class="form-box">
      <div class="form-title">
        <div class="two-button">
          ...
          <button class="l-submit-button no-css-btn" @click="submitCinfo">
      ...
      <div class="l-scroll">
        ...
        <div class="l-input input-date">
          ...
          <input v-model="licenseNumber" type="text" id="l-Number" />
        </div>
...
export default {
  ...
  methods: {
    ...
    submitCinfo() {
      ...
      // console.log(data);
      LicenseApi.requestInsertLicense(
        data,
        res => {
          // console.log("########");
          console.log(res);
          if (res.data == data.licenseNumber) {
            tempData.LICENSE_NUMBER = res.data;
            // console.log("trans data :", tempData);
            this.$emit("pushNewCertiData", tempData);
          }
          // this.$emit("pushNewCertiData", data);
          // console.log("emit?");
        },
        error => {
          console.log(error);
