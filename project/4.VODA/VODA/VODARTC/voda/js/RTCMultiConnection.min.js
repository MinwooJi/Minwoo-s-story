...
var RTCMultiConnection = function (roomid, forceOptions) {
  function SocketConnection(connection, connectCallback) {
      ...
      if (message.remoteUserId == connection.userid) {
        ...
        if (message.message.allParticipants)
          return (
            ...
            void message.message.allParticipants.forEach(function (
              participant
            ) {
              mPeer[
    ...
    (connection.socket.resetProps = function () {
      ...
      connection.socket.on("closed-entire-session", function (
        sessionid,
        extra
      ) {
        connection.leave(),
  ...
  function getRMCMediaElement(stream, callback, connection) {
    ...
    if (
      ...
      mediaElement.setAttribute("muted", !1),
  ...
  !(function (connection) {
    ...
    (mPeer.onGettingLocalMedia = function (stream, callback) {
      ...
      (connection.replaceTrack = function (
        session,
        remoteUserId,
        isVideoTrack
      ) {
    ...
    (connection.getExtraData = function (remoteUserId, callback) {
      ...
      return "function" == typeof callback
        ...
        ? connection.peers[remoteUserId].extra
        : connection.peersBackup[remoteUserId]
        ? connection.peersBackup[remoteUserId].extra
        : {};
    }),
